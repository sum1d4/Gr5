...
// セッション保存された正解
$correct_answer = $_SESSION["kaki_correct_answer"] ?? null;
...
// 3. 正解数カウント
// -----------------------------
if (!isset($_SESSION["kaki_correct_count"])) {
    $_SESSION["kaki_correct_count"] = 0;
}
if ($is_correct) {
    $_SESSION["kaki_correct_count"]++;
}

$_SESSION["kaki_current_q"]++;
