...
// 1) 正解判定
// ---------------------------------------------------------
if (!isset($_SESSION["failed_1kaki_correct_answer"])) {
    die("正解データがありません。");
}

$correct_answer = $_SESSION["failed_1kaki_correct_answer"];
...
// ---------------------------------------------------------
// 5) 終了処理（UNSETは redirect のあと）
// ---------------------------------------------------------
if ($_SESSION["failed_1kaki_qnum"] > $max_questions) {

    $total   = $max_questions;
    $correct = $_SESSION["failed_1kaki_correct"];
...
$next_link = "failed_1kaki.php";
$menu_link = "mode_select.php?grade=1&subject=kaki";
?>
<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8">
<title>けっか（1年 かき）</title>
...
<div class="container">
    ...
    <div class="info-container">
        ...
        <div class="question-info">
            もんだい: <?= htmlspecialchars($question_text) ?>
            <?php if (!empty($question_okuri)): ?>
                <span style="color:#666;">（<?= htmlspecialchars($question_okuri) ?>）</span>
            <?php endif; ?>
        </div>
